...
import { ArrowLeft, MapPin, Phone, Mail, User, LogOut } from 'lucide-react';
...
export default function ReportLost() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Call backend API
      const apiResponse = await fetch(`${import.meta.env.VITE_API_URL || '/api'}/items/lost`, {
        method: 'POST',
        body: formDataToSend,
      });
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-16">
            ...
            <h1 className="ml-2 sm:ml-4 text-base sm:text-xl font-semibold text-gray-900">Report Lost Item</h1>
            {isAuthenticated && (
